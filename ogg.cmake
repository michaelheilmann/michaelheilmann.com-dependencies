...
ExternalProject_Add(${target}-external
                    ...
                    GIT_SHALLOW TRUE
                    PREFIX ${CMAKE_CURRENT_BINARY_DIR}/my-ogg
...
add_custom_command(OUTPUT ${${target}-PACKAGE_DIR}/.create-libraries-stamp-${suffix}
                   ...
                   COMMAND ${CMAKE_COMMAND} -E copy ${${target}-BUILD_DIR}/${configuration}/$<IF:$<CONFIG:Debug>,ogg.lib,ogg.lib>
                                                    ${${target}-PACKAGE_LIBRARIES_DIR}/ogg.lib
...
add_custom_command(OUTPUT ${${target}-PACKAGE_DIR}/.create-includes-stamp-${suffix}
                   DEPENDS ${target}-CREATE-DIRECTORIES ${target}-external
                   COMMAND ${CMAKE_COMMAND} -E copy ${${target}-BUILD_DIR}/include/ogg/config_types.h
                                                    ${${target}-PACKAGE_INCLUDES_DIR}/ogg/config_types.h
                   COMMAND ${CMAKE_COMMAND} -E copy ${${target}-SOURCE_DIR}/include/ogg/ogg.h
                                                    ${${target}-PACKAGE_INCLUDES_DIR}/ogg/ogg.h
                   COMMAND ${CMAKE_COMMAND} -E copy ${${target}-SOURCE_DIR}/include/ogg/os_types.h
                                                    ${${target}-PACKAGE_INCLUDES_DIR}/ogg/os_types.h
