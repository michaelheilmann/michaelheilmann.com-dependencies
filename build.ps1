...
if (0) {
  ...
  Invoke-CMAKE -Arguments "-S ./../../.unpack/libressl" "-B .";

  Invoke-CMAKE -Arguments "--build . --config Debug";
  Invoke-CMAKE -Arguments "--install . --config Debug --prefix './../../.dependencies/debug/libressl'";

  Invoke-CMAKE -Arguments "--build . --config Release"
  Invoke-CMAKE -Arguments "--install . --config Release --prefix './../../.dependencies/release/libressl'"

  Invoke-CMAKE -Arguments "--build . --config MinSizeRel"
  Invoke-CMAKE -Arguments "--install . --config MinSizeRel --prefix './../../.dependencies/minsizerel/libressl'"

  Invoke-CMAKE -Arguments "--build . --config RelWithDebInfo"
  Invoke-CMAKE -Arguments "--install . --config RelWithDebInfo --prefix './../../.dependencies/relwithdebinfo/libressl'"
...
if (0) {
  ...
  $cmd = ,"cmake"
  $cmd += $commonCmd
  Invoke-Call @CMAKE -Arguments "${cmd} ${commonCmd} -S ./../../.unpack/openal-soft -B ."
  Invoke-CMAKE -Arguments "--build . --config Debug"
  Invoke-CMAKE -Arguments "--install . --config Debug --prefix './../../.dependencies/debug/openal-soft'"
