...
if (-Not(($TargetArchitecture -eq 'x64') -or ($TargetArchitecture -eq 'x86'))) {
  Write-Host "'TargetArchitecture' must be either 'x64' or 'x86'"
  exit 1;  
}
...
if (1) {
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-S ./../../.unpack/libressl", "-B ."
...
if (1) {
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-S ./../../.unpack/zlib", "-B ."
...
if (1) {
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-DZLIB_ROOT=$pwd\..\..\.dependencies\debug\zlib", "$commonCmd", "-S ./../../.unpack/libpng", "-B ."
  Invoke-Call @cmd
  Invoke-Call cmake --build . --config Debug
  Invoke-Call cmake --install . --config Debug --prefix './../../.dependencies/debug/libpng'

  $cmd = "cmake", "-A $TargetArchitecture", "-DZLIB_ROOT=./../../.dependencies/release/zlib", "$commonCmd", "-S ./../../.unpack/libpng", "-B ."
  Invoke-Call @cmd
  Invoke-Call cmake --build . --config Release
  Invoke-Call cmake --install . --config Release --prefix './../../.dependencies/release/libpng'

  $cmd = "cmake", "-A $TargetArchitecture", "-DZLIB_ROOT=./../../.dependencies/minsizerel/zlib", "$commonCmd", "-S ./../../.unpack/libpng", "-B ."
  Invoke-Call @cmd
  Invoke-Call cmake --build . --config MinSizeRel
  Invoke-Call cmake --install . --config MinSizeRel --prefix './../../.dependencies/minsizerel/libpng'

  $cmd = "cmake", "-A $TargetArchitecture", "-DZLIB_ROOT=./../../.dependencies/relwithdebinfo/zlib", "$commonCmd", "-S ./../../.unpack/libpng", "-B ." 
  Invoke-Call @cmd
  Invoke-Call cmake --build . --config RelWithDebInfo
...
if (1) {
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-DPNG_PNG_INCLUDE_DIR=./../../.dependencies/debug/libpng/include", "-DPNG_LIBRARY=./../../.dependencies/debug/libpng/lib/libpng18_staticd.lib"
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-DPNG_PNG_INCLUDE_DIR=./../../.dependencies/release/libpng/include", "-DPNG_LIBRARY=./../../.dependencies/release/libpng/lib/libpng18_static.lib"
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-DPNG_PNG_INCLUDE_DIR=./../../.dependencies/minsizerel/libpng/include", "-DPNG_LIBRARY=./../../.dependencies/minsizerel/libpng/lib/libpng18_static.lib"
  ...
  $cmd = "cmake", "-A $TargetArchitecture", "-DPNG_PNG_INCLUDE_DIR=./../../.dependencies/relwithdebinfo/libpng/include", "-DPNG_LIBRARY=./../../.dependencies/relwithdebinfo/libpng/lib/libpng18_static.lib"
...
if (1) {
  ...
  $commonCmd = @( "-A $TargetArchitecture" 
